        ...
        '<div class="modal-dialog mirador-modal" role="document">',
          '<div class="modal-content">',
            ...
            '<div class="modal-body">',
              ...
              '<ul>',
                '<li><input class="annotations-checkbox" type="checkbox" value="Enable public annotations"></li>',
                '<li><input class="display-default-checkbox" type="checkbox" value="Display by default"></li>',
    ...
    template: [
      '<div class="clearfix" data-behavior="mirador-widget">',
        ...
        '<div class="row mirador-setup">',
          '<div class="col-sm-8 panels dd nestable-item-grid" data-behavior="nestable" data-max-depth="1">',
            '<ol class=" dd-list" data-behavior="items-section"></ol>',
          '</div>',
          '<fieldset class="col-sm-8 mirador-source-location" data-behavior="mirador-source-location-fieldset">',
            '<div class="clearfix">',
