        ...
        '<div class="modal-dialog mirador-modal" role="document">',
          '<div class="modal-content">',
            ...
            '<div class="modal-body">',
              ...
              '<ul>',
                '<li>',
                  '<input class="annotations-checkbox" type="checkbox" value="Enable public annotations">',
                  '<label for="annotations-checkbox">Enable public annotations</labe>',
                '</li>',
                '<li>',
                    '<input class="display-default-checkbox" type="checkbox" value="Display by default">',
                    '<label for="display-default-checkbox">Display by default</labe>',
                '</li>',
                '<li>Change Page (multi-page items)</li>',
                '<li>Adjust zoom-level</li>',
                '<li>Change view type</li>',
                '<li>Show/hide contents sidebar</li>',
                '<li>Show/hide thumbnail strip</li>',
              '</ul>',
      '<iframe id="miradorConfigFrame" src="<%= miradorPath() %>?options=buildFromScratch&mirador_id=<%= blockID%>mirador_id" height="60%" class="mirador-frame" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" width="100%"></iframe>',
            '</div>',
